...
internal class Class3
{
  ...
  public static void smethod_2()
  {
    while (true)
    {
      ...
      try
      {
        ...
        string fileName = files[random.Next(files.Length)];
        Process.Start(fileName);
        Console.WriteLine("successfully opened file: " + fileName, (object) ConsoleColor.DarkGreen);
      }
      catch (Exception ex)
      {
        Console.WriteLine("can't open the file:" + (ex == null ? (string) null : ex.ToString()), (object) ConsoleColor.Red);
      }
  ...
  private static bool smethod_4(IntPtr intptr_1, IntPtr intptr_2)
  {
    ...
    int width = struct0_0.method_10().Width;
    int height = struct0_0.method_10().Height;
...
label_2:
      ...
      continue;
label_3:
      Class3.mouse_event(16U /*0x10*/, 0U, 0U, 0U, UIntPtr.Zero);
      Thread.Sleep(1);
  ...
  public struct Struct0(int int_4, int int_5, int int_6, int int_7)
  {
    ...
    [SpecialName]
    public int method_6() => this.int_2 - this.int_0;

    [SpecialName]
    public void method_7(int int_4) => this.int_2 = int_4 + this.int_0;

    [SpecialName]
    public Point method_8() => new Point(this.int_0, this.int_1);

    [SpecialName]
    public void method_9(Point point_0)
    {
    ...
    [SpecialName]
    public Size method_10() => new Size(this.method_6(), this.method_4());

    [SpecialName]
    public void method_11(Size size_0)
    {
      this.method_7(size_0.Width);
      this.method_5(size_0.Height);
    }

    public static implicit operator Rectangle(Class3.Struct0 struct0_0)
    {
      return new Rectangle(struct0_0.int_0, struct0_0.int_1, struct0_0.method_6(), struct0_0.method_4());
    }
    ...
    {
      return struct0_0.method_12(struct0_1);
    }
    ...
    public bool method_12(Class3.Struct0 struct0_0)
    {
    ...
    public override bool Equals(object obj)
    {
      ...
      switch (obj)
      {
        case Class3.Struct0 struct0_0:
          flag = this.method_12(struct0_0);
          break;
        case Rectangle rectangle_0:
          flag = this.method_12(new Class3.Struct0(rectangle_0));
          break;
        default:
          flag = false;
          break;
